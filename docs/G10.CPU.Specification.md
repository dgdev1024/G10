...
registers. However, the G10 CPU allows any of the `D*`, `W*` and `H*` registers
...
| `0x4E0Y MFI HY`           | 2         | 2         | Moves the current value of register `HY` into the Flags Register (`FR`).                          |
| `0x4FX0 MFO HX`           | 2         | 2         | Moves the current Flags Register (`FR`) value into register `HX`.                                 |
