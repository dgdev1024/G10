...
namespace G10::CPU
{
    ...
    private: // Methods - Instruction Execution ********************************
        ...
        static auto ExecuteADC_LX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteADC_LX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteADC_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_LX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_LX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSBC_LX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSBC_LX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSBC_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteADD_WX_IMM16 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteADD_WX_WY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteADD_DX_IMM32 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteADD_DX_DY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_WX_IMM16 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_WX_WY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_DX_IMM32 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_DX_DY (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteAND_LX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteAND_LX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteAND_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteOR_LX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteOR_LX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteOR_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteXOR_LX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteXOR_LX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteXOR_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteCMP_LX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteCMP_LX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteCMP_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSLA_LX (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSLA_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteSRA_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteSRL_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteSWAP_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteRL_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteRLC_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteRR_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteRRC_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteBIT_Y_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteSET_Y_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteRES_Y_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteTOG_Y_HX (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteLDI_HX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLDD_LX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLDD_HX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTI_pDX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTI_pDX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTD_pDX_LY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTD_pDX_HY (Core& pCore, const Instruction& pInst) -> bool;
        ...
        static auto ExecuteLD_HX_IMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLD_HX_pIMM32 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLD_HX_pDY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLDQ_HX_pIMM16 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLDQ_HX_pWY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLDP_HX_pIMM8 (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteLDP_HX_pLY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteST_pIMM32_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteST_pDX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTQ_pIMM16_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTQ_pWX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTP_pIMM8_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSTP_pLX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteMV_HX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteADD_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteADC_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSUB_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteSBC_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteINC_HX (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteDEC_HX (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteAND_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteOR_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteXOR_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteNOT_HX (Core& pCore, const Instruction& pInst) -> bool;
        static auto ExecuteCMP_LX_HY (Core& pCore, const Instruction& pInst) -> bool;
