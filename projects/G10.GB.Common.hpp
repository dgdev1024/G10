...
namespace G10::GB
{
    constexpr std::uint32_t
        ...
        kMemSpecialRamStartAddr         = 0x80000000,
            kMemVideoRamB0StartAddr     = 0x80004000,
            kMemVideoRamB0EndAddr       = 0x80005FFF,
            kMemVideoRamB1StartAddr     = 0x80006000,
            kMemVideoRamB1EndAddr       = 0x80007FFF,
            kMemVideoRamStartAddr       = 0x80008000,
            kMemVideoRamEndAddr         = 0x80009FFF,
            kMemColorRamStartAddr       = 0x8000A000,
            kMemColorRamEndAddr         = 0x8000A07F,
