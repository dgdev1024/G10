...
namespace G10::ASM
{
    std::unordered_map<std::string_view, Keyword> Keyword::mLookup =
    {
        ...
        // x86-style Registers
        { "EAX", Keyword { CPU::Register::D0 } },
        { "EBX", Keyword { CPU::Register::D1 } },
        { "ECX", Keyword { CPU::Register::D2 } },
        { "EDX", Keyword { CPU::Register::D3 } },
        { "R8D",  Keyword { CPU::Register::D8  } },
        { "R9D",  Keyword { CPU::Register::D9  } },
        { "R10D", Keyword { CPU::Register::D10 } },
        { "R11D", Keyword { CPU::Register::D11 } },
        { "R12D", Keyword { CPU::Register::D12 } },
        { "R13D", Keyword { CPU::Register::D13 } },
        { "R14D", Keyword { CPU::Register::D14 } },
        { "R15D", Keyword { CPU::Register::D15 } },
        { "AX",  Keyword { CPU::Register::W0  } },
        { "BX",  Keyword { CPU::Register::W1  } },
        { "CX",  Keyword { CPU::Register::W2  } },
        { "DX",  Keyword { CPU::Register::W3  } },
        { "R8W",  Keyword { CPU::Register::W8  } },
        { "R9W",  Keyword { CPU::Register::W9  } },
        { "R10W", Keyword { CPU::Register::W10 } },
        { "R11W", Keyword { CPU::Register::W11 } },
        { "R12W", Keyword { CPU::Register::W12 } },
        { "R13W", Keyword { CPU::Register::W13 } },
        { "R14W", Keyword { CPU::Register::W14 } },
        { "R15W", Keyword { CPU::Register::W15 } },
        { "AH",  Keyword { CPU::Register::H0  } },
        { "BH",  Keyword { CPU::Register::H1  } },
        { "CH",  Keyword { CPU::Register::H2  } },
        { "DH",  Keyword { CPU::Register::H3  } },
        { "AL",  Keyword { CPU::Register::L0  } },
        { "BL",  Keyword { CPU::Register::L1  } },
        { "CL",  Keyword { CPU::Register::L2  } },
        { "DL",  Keyword { CPU::Register::L3  } },
        { "R8B", Keyword { CPU::Register::L8  } },
        { "R9B", Keyword { CPU::Register::L9  } },
        { "R10B", Keyword { CPU::Register::L10 } },
        { "R11B", Keyword { CPU::Register::L11 } },
        { "R12B", Keyword { CPU::Register::L12 } },
        { "R13B", Keyword { CPU::Register::L13 } },
        { "R14B", Keyword { CPU::Register::L14 } },
        { "R15B", Keyword { CPU::Register::L15 } },
        ...
        // GBZ80-Style Condition Codes
        { "Z", Keyword { CPU::Condition::ZS } },
        { "NZ", Keyword { CPU::Condition::ZC } },
        { "C", Keyword { CPU::Condition::CS } },
        { "NC", Keyword { CPU::Condition::CC } },
        { "V", Keyword { CPU::Condition::VS } },
        { "NV", Keyword { CPU::Condition::VC } },
        ...
        { ".OPERATOR", Keyword { PreprocessorDirective::SNIPPET } },
        { ".OPER", Keyword { PreprocessorDirective::SNIPPET } },
        { ".OP", Keyword { PreprocessorDirective::SNIPPET } },
